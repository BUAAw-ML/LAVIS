...
#         }
    ...
    #   for caption_file_path in module_config.config.values():
        ...
        for idx, item in enumerate(self.annotation):
            ...
            description = caption_features[str(image_id)][0]['caption']
    ...
    def retriever_data(self, model_name='gtr-t5-large', output_filename='/mnt/data/qbwang/lavis/data', top_k=3,
        ...
        for idx, item in enumerate(self.annotation):
            ...
            results[item['question_id']] = text[0]
